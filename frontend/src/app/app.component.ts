...
<section appResponseAdmin *ngIf="responses().length" class="mt-6 card" [responses]="responses()" [(responseQuery)]="responseQuery" (responseOpen)="openResponse($event)"></section>
