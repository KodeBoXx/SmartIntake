...
def build_components(members: list[dict[str, Any]]) -> dict[str, Any]:
    schemas: dict[str, Any] = {
        ...
        "CanonicalDecimal": {"type": "string", "pattern": "^(?:0|-[1-9][0-9]*|[1-9][0-9]*)(?:\\.[0-9]*[1-9])?$", "format": "canonical-decimal", "description": "Canonical expression-result decimal string with no redundant fractional zeroes; JSON number is forbidden."},
