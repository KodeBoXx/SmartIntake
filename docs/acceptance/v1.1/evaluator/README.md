...
Release 2.4.21-m0 pins the executable T22 browser probe (`assets/t22_browser_discovery_probe.py`, SHA-256 `230e9061eff59895286d11d1f2ee3d2100320df6856395b9a0bda8afb4d4c9d2`, mode `0755`). Browser execution retains and revalidates original provider HTTP bytes before parsing, requires provider-session-scoped AT identity, keeps one discovered session set across both respondent package series with outer-finally cleanup, and enforces 3,600-second release-authority freshness.
