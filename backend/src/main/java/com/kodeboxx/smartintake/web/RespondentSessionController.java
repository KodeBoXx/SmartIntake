...
public class RespondentSessionController {
 ...
 @GetMapping("/sessions/{id}/submission-operation") public Map<String,Object> submissionOperation(@PathVariable UUID id,@RequestHeader(value="X-Respondent-Session",required=false) String token){return intake.submissionOperation(id,token);}
}
