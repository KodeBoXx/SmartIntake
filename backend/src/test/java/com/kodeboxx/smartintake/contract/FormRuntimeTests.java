...
class FormRuntimeTests {
 ...
 @Test void calculatesOnlyFromServerAnswers(){Map<String,Object> expression=Map.of("op","add","args",List.of(Map.of("ref",Map.of("fieldId","a")),Map.of("literal",Map.of("type","integer","value",2))));Map<String,Object> d=Map.of("contractVersion","4.0.0","pages",List.of(Map.of("id","p","fields",List.of(Map.of("id","a","type","integer"),Map.of("id","total","type","calculated","calculation",expression)))));assertEquals("5",String.valueOf(runtime.calculatedAnswers(d,Map.of("a",3,"total",999)).get("total")));}
