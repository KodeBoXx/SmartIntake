 ...
 */
@JsonPropertyOrder({
  FolderUpdateRequest.JSON_PROPERTY_NAME,
  FolderUpdateRequest.JSON_PROPERTY_PARENT_ID
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.10.0")
public class FolderUpdateRequest extends HashMap<String, Object> {
  ...
  public FolderUpdateRequest name(@jakarta.annotation.Nonnull String name) {
  ...
  public FolderUpdateRequest parentId(@jakarta.annotation.Nullable FolderUpdateRequestParentId parentId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, folderUpdateRequest.name) &&
        equalsNullable(this.parentId, folderUpdateRequest.parentId) &&
        super.equals(o);
  }
