 ...
 */
@JsonPropertyOrder({
  DraftResponse.JSON_PROPERTY_REQUEST_ID,
...
public class DraftResponse {
  ...
  public DraftResponse draft(@jakarta.annotation.Nonnull Draft draft) {
  ...
  @JsonProperty(JSON_PROPERTY_DRAFT)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setDraft(@jakarta.annotation.Nonnull Draft draft) {
    this.draft = draft;
  }
